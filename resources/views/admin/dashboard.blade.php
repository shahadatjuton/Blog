        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-cyan hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to=" 55 " data-speed="1000" data-fresh-interval="20"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
            ...
            <div class="info-box bg-brown hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{$tags}}" data-speed="15" data-fresh-interval="20"></div>
                </div>
            </div>
            ...
            <div class="info-box bg-grey hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{$new_author}}" data-speed="15" data-fresh-interval="20"></div>
                </div>
            </div>
        </div>
